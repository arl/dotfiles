...
files="bash_aliases bashrc gitconfig profile machine_specific pylintrc screenrc vimrc tmux.conf tmux-git vim/colors/*.vim vim/ftdetect/go.vim vim/syntax/go.vim" 
##########
