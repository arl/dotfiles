...
files="bash_aliases bashrc gitconfig profile pylintrc screenrc vimrc tmux.conf tmux-git bash-git-prompt git-prompt-colors.sh fonts/* vim/colors/*.vim vim/ftdetect/go.vim vim/syntax/go.vim" 
##########
