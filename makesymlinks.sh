...
files="bash_aliases bashrc dircolors gitconfig gdbinit inputrc profile pylintrc screenrc vimrc gvimrc tmux.conf tmux-git bash-git-prompt git-prompt-colors.sh agignore fonts/* vim/colors/*.vim vim/ftdetect/go.vim vim/syntax/go.vim" 
##########
